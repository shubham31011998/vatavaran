...
export default function LoginScreen() {
  ...
  return (
    <View className="flex-1 bg-white" style={{backgroundColor: themeColors.black_1}}>
      <SafeAreaView className="flex ">
        <View className="flex-row justify-start">
          <TouchableOpacity onPress={() => navigation.goBack()}
            className="p-2 rounded-tr-2xl rounded-bl-2xl ml-4" style={{backgroundColor: themeColors.blue_1}}>
      ...
      <View
        style={{borderTopLeftRadius: 30, borderTopRightRadius: 30, backgroundColor: themeColors.black_2}}
        ...
        <View className="form space-y-2">
          ...
          <TextInput
            className="p-4 bg-black text-gray-400 rounded-2xl"
            secureTextEntry
